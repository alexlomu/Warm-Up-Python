...
iterations = 10000
variables = ["Trabajo", "Salario", "Condiciones", "Desarrollo de carrera", "Impacto social", "Seguridad", "Balance de vida", "Ubicación", "Ambiente laboral", "Viajes"]

def Monte_Carlo(grade):
    final_results = []
    weight = [0.15, 0.10, 0.11, 0.09, 0.09, 0.10, 0.08, 0.09, 0.10, 0.09]
